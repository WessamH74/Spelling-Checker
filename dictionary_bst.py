...
if __name__ == "__main__":
    ...
    def get_word(word): #O(LOGN)
        ...
        if node == None:
            ...
            add_word(word)
            return f"This word not exists in the dictionary, word has added to dictionary\
    ...
    while True:
        print(get_word(input('Enter a word to check if it exists in the dictionary or not: ').lower()))
